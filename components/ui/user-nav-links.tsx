      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            className={clsx(
              "flex h-[48px] grow items-center justify-center gap-2 rounded-md lg:rounded-lg bg-gray-100 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600  md:p-2 md:px-3",
              {
